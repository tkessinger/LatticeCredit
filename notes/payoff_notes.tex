...
Okay, let's carefully break this down a little more.
An individual's payoff from the PGG \emph{in which they are focal} will be the above.
An individual's payoff from the PGG \emph{in which they are not focal} will be
